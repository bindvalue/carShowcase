...
// ═══════════════════════════════════════════════════════
// CONTEÚDO (server component assíncrono)
// ═══════════════════════════════════════════════════════
...
async function AssinaturaContent() {
  ...
  // ═══════════ 3 ESTADOS ═══════════
  // 1. Nunca assinou → mostra form + aviso "sem assinatura"
  // 2. Assinou mas inadimplente → aviso "inativo" + histórico
  // 3. Ativo → card normal
